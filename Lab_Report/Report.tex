...
%
% --- Sidebar background (drawn first, with TikZ overlay) ---
\begin{tikzpicture}[remember picture, overlay]
    \fill[primary] (current page.south west) rectangle ([xshift=7cm]current page.north west);
    % Thin accent strip
    \fill[accent] ([xshift=7cm]current page.south west) rectangle ([xshift=7.2cm]current page.north west);
\end{tikzpicture}
%
% --- Two-column layout: sidebar (7cm) | main content (rest) ---
\noindent
\begin{minipage}[t][\textheight][t]{7cm}
    \centering
    \vspace*{1.5cm}
    {\color{white}\large\bfseries DEPARTMENT OF} \\[2pt]
    {\color{white}\large\bfseries COMPUTER SCIENCE} \\[2pt]
    {\color{white}\large\bfseries \& ENGINEERING} \\[0.6cm]
    \rule{4cm}{0.4pt} \\[0.4cm]
    {\color{white}\itshape\large Faculty of Science} \\[2pt]
    {\color{white}\itshape\large and Information} \\[2pt]
    {\color{white}\itshape\large Technology} \\[0.6cm]
    \rule{4cm}{0.4pt} \\[0.8cm]
    {\color{white}\Large\bfseries AI \& ML Lab} \\[0.3cm]
    {\color{accent}\large\bfseries Lab Report}
\end{minipage}%
\hfill
\begin{minipage}[t][\textheight][t]{\dimexpr\textwidth-7.2cm\relax}
    \vspace*{2.5cm}
    \begin{center}
        {\color{primary}\rule{0.5\linewidth}{0.8pt}} \\[0.6cm]
        {\color{primary!70!black}\Large\itshape Comprehensive Lab Report} \\[2.5cm]

        {\color{primary}\Huge\bfseries A Comparative Study} \\[0.4cm]
        {\color{primary}\Huge\bfseries of Six Foundational} \\[0.4cm]
        {\color{primary}\Huge\bfseries Machine Learning Models} \\[0.6cm]
        {\color{primary}\rule{0.5\linewidth}{0.8pt}} \\[0.5cm]
        {\color{primary!70!black}\large\itshape
            Linear \& Logistic Regression $\bullet$ SVM $\bullet$ KNN $\bullet$\\[2pt]
    ...
    \begin{tabular}{r@{\hspace{0.6cm}}l}
        \toprule
        \rowcolor{soft}
        \multicolumn{2}{c}{\bfseries\color{primary} Submitted by} \\[2pt]
        \midrule
        ...
        \midrule
        \rowcolor{soft}
        \multicolumn{2}{c}{\bfseries\color{primary} Submitted to} \\[2pt]
        \midrule
        \textbf{Course Instructor} & Sabbir Ahmed \\
        \textbf{Course Title}    & AI \& Machine Learning Lab \\
        \midrule
        \rowcolor{soft}
        \multicolumn{2}{c}{\bfseries\color{primary} Submission} \\[2pt]
        \midrule
    ...
    \begin{center}
        {\color{primary!70!black}\bfseries\large Source Code \& Datasets} \\[4pt]
