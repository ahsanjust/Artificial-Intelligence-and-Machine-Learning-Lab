...
% --- Top decorative mark ---
{\color{accent}\rule[0.5ex]{2.5cm}{1.5pt}}

\vspace{1.0cm}

% --- Institutional header ---
{\color{primary}\Large\scshape Department of Computer Science} \\[3pt]
{\color{primary}\Large\scshape and Engineering} \\[4pt]
{\color{primary!70!black}\normalsize\itshape Faculty of Science and Information Technology}

\vspace{0.6cm}

% --- Course info ---
{\color{primary!80!black}\large\bfseries Artificial Intelligence} \\[2pt]
{\color{primary!80!black}\large\bfseries and Machine Learning Lab} \\[2pt]
{\color{primary!70!black}\normalsize\itshape Comprehensive Laboratory Report}
...
{\color{primary}\Huge\bfseries Machine Learning Models}

\vspace{0.5cm}

% --- Single thick accent bar under the title ---
{\color{accent}\rule{0.45\linewidth}{1.5pt}}

\vspace{0.4cm}

% --- Subtitle with the six model names ---
{\color{primary!80!black}\large\itshape
...
% --- Thin separator ---
{\color{primary!40}\rule{0.55\linewidth}{0.4pt}}

\vspace{0.8cm}

% --- Author / submission block (three labelled rows) ---
\renewcommand{\arraystretch}{1.5}
\begin{tabularx}{0.85\linewidth}{r@{\hspace{0.7cm}}>{\bfseries}l}
    % Submitted by
    {\color{primary!70!black}\scshape Submitted by}  & Ahsanul Haque \\
    {\color{primary!70!black}\scshape Student ID}    & 220119 \\
    {\color{primary!70!black}\scshape Section}       & 3 -- 2 \\
    \\[6pt]
    % Submitted to
    {\color{primary!70!black}\scshape Submitted to}  & Sabbir Ahmed \\
    {\color{primary!70!black}\scshape Course}        & AI \& Machine Learning Lab \\
    \\[6pt]
    % Submission
    {\color{primary!70!black}\scshape Date}          & June 15, 2026 \\
    {\color{primary!70!black}\scshape Report Type}   & Comprehensive Lab Report \\
\end{tabularx}
...
% --- Footer: GitHub link (the only bottom-anchored element) ---
{\color{primary!70!black}\small\bfseries Source Code \& Datasets} \\[4pt]
{\color{primary}\small\url{https://github.com/ahsanjust/Artificial-Intelligence-and-Machine-Learning-Lab}}

\vspace{0.8cm}

% --- Bottom decorative mark (mirrors the top) ---
{\color{accent}\rule[-0.5ex]{2.5cm}{1.5pt}}
