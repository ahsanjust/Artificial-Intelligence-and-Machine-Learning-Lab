...
\noindent \emph{To open a notebook in Google Colab, navigate to the GitHub URL above
and click the \emph{Open in Colab} badge, or use
\emph{File $\rightarrow$ Open notebook $\rightarrow$ GitHub tab} and paste the
URL.}
